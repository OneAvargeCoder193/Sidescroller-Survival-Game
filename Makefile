...
CFLAGS = $(shell sdl2-config --cflags) $(shell pkg-config --cflags SDL2_image) $(shell pkg-config --cflags SDL2_ttf)

LDFLAGS = $(shell sdl2-config --ldflags) $(shell pkg-config --ldflags SDL2_image) $(shell pkg-config --ldflags SDL2_ttf)
